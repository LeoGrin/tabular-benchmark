...
was used in the original paper (not from the rtdl package): [ft_transformer.py](models/tabular/bin/ft_transformer.py).
...
## 1. The main results
The tables from the main text (with extra details) can be found in [this notebook](models/tabular/bin/report.ipynb).
