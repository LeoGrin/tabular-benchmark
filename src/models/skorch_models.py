...
from models.tabr.bin.tabr import Model, InputShapeSetterTabR #TODO: maybe chnage the name of the class
...
def create_excelformer_skorch(id, wandb_run=None, use_checkpoints=True,
...
def create_tabr_skorch(id, wandb_run=None, use_checkpoints=True,
                         categorical_indicator=None, **kwargs):
    print("kwargs", kwargs)
    if "verbose" not in kwargs:
        verbose = 0
