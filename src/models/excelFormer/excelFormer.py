...
#taken from https://github.com/WhatAShot/ExcelFormer/blob/main/bin/excel_former.py
# commit bdd1dae45c79dbbb94984f34a0405c4da2dc6ac9

#import lib
# instead of importing, we copy the useful functions here
...
class ExcelFormer(nn.Module):
    ...
    def forward(self,
                x):
     #x_num: Tensor, x_cat: ty.Optional[Tensor], mixup: bool=False, beta=0.5, mtype='feat_mix') -> Tensor:
        #MODIF
        x_cat = None
        x_num = x
        mtype = self.mtype
