...
ggsave("analyses/plots/benchmark_time_numerical_classif.jpg", width=7, height=6)
...
ggsave("analyses/plots/benchmark_time_numerical_regression.jpg", width=7, height=6)
...
plot_aggregated_results_time(df, score="R2 score", quantile=0.5, truncate_scores = T, y_inf=0.5)


ggsave("analyses/plots/benchmark_time_categorical_regression.jpg", width=7, height=6)
...
plot_aggregated_results_time(df, y_inf=0.5)

ggsave("analyses/plots/benchmark_time_categorical_classif.jpg", width=7, height=6)
